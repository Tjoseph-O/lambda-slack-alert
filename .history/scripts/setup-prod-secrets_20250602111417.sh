...
# Prompt for production credentials securely
...
# Create production Slack webhook secret
...
# Create production MongoDB URI parameter
...
# Create production MongoDB database parameter
